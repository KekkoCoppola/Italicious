...
<%@ include file="layout.jsp" %>
    ...
    <section class="hero-section text-white py-16">
        <div class="container mx-auto px-4 text-center">
            ...
            <button class="bg-white text-green-700 hover:bg-gray-100 font-bold py-3 px-8 rounded-full text-lg transition transform hover:scale-105">
                Esplora il Catalogo
            </button>
        </div>
    </section>
    ...
    <section class="py-12 bg-white">
        <div class="container mx-auto px-4">
            ...
            <div class="relative max-w-4xl mx-auto">
                ...
                <svg viewBox="0 0 800 1000" class="w-full h-auto">
                    <!-- Nord Italia -->
                    ...
                    <path id="emilia" class="region region fill-red-100 hover:fill-red-300 stroke-white stroke-1" d="M240,250 L260,230 L280,250 L300,260 L320,290 L340,300 L360,320 L340,340 L320,330 L300,350 L280,330 L260,350 L240,330 L220,310 L240,290 Z" onclick="showRegion('Emilia-Romagna')"/>
    ...
    <section class="py-12 bg-gray-50">
        <div class="container mx-auto px-4">
            ...
            <div class="text-center mt-10">
                <button class="bg-white text-green-600 border-2 border-green-600 hover:bg-green-600 hover:text-white font-bold py-3 px-8 rounded-full text-lg transition transform hover:scale-105">
