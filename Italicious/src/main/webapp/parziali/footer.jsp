        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    ...
                    <p class="text-gray-400">Portiamo i sapori autentici d'Italia direttamente a casa tua.</p>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="#" class="text-gray-400 hover:text-white transition">Catalogo</a></li>
                        <li><a href="#" class="text-gray-400 hover:text-white transition">Cerca</a></li>
                        <li><a href="#" class="text-gray-400 hover:text-white transition">Accedi</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        <li class="flex items-center"><i class="fas fa-map-marker-alt mr-2"></i> Via Roma 123, 00100 Roma</li>
                        <li class="flex items-center"><i class="fas fa-phone mr-2"></i> +39 06 1234567</li>
                        <li class="flex items-center"><i class="fas fa-envelope mr-2"></i> info@italicious.com</li>
                    </ul>
                </div>
            </div>
            
            <div class="border-t border-gray-700 mt-12 pt-8 text-center text-gray-400">
                <p>&copy; 2023 Italicious. Tutti i diritti riservati.</p>
            </div>
        </div>
    </footer>