        ...
        <div class="container mx-auto px-4">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="flex items-center space-x-1">
                    ...
                    <a href="#" class="text-2xl font-bold text-gray-800 hover:text-green-700 transition">
                ...
                <div class="hidden md:flex space-x-8">
                    <a href="#" class="text-gray-800 hover:text-green-600 font-medium transition">Home</a>
                    <a href="#" class="text-gray-800 hover:text-green-600 font-medium transition">Chi Siamo</a>
                    <a href="#" class="text-gray-800 hover:text-green-600 font-medium transition">Catalogo</a>
                    <a href="#" class="text-gray-800 hover:text-green-600 font-medium transition">Cerca</a>
                    <a href="#" class="text-gray-800 hover:text-green-600 font-medium transition">Accedi</a>
                </div>
            ...
            <div class="md:hidden hidden py-4" id="mobile-menu">
                <a href="#" class="block py-2 text-gray-800 hover:text-green-600 transition">Home</a>
                <a href="#" class="block py-2 text-gray-800 hover:text-green-600 transition">Chi Siamo</a>
                <a href="#" class="block py-2 text-gray-800 hover:text-green-600 transition">Catalogo</a>
                <a href="#" class="block py-2 text-gray-800 hover:text-green-600 transition">Cerca</a>
                <a href="#" class="block py-2 text-gray-800 hover:text-green-600 transition">Accedi</a>
            </div>
        </div>
    </nav>